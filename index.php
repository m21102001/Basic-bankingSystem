...
<head>
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="statics/apple-touch-icon.jpeg">
    <link rel="icon" type="image/png" sizes="32x32" href="statics/favicon-32x32.jpeg">
    <link rel="icon" type="image/png" sizes="16x16" href="statics/favicon-16x16.jpeg">
    ...
    <div id="container">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed fixed-top" style="font-family:candara; font-size:18px; box-shadow: 0px 0px 10px 0px black;">
            <div class="container-fluid">
                <a href="index.php"><img src="statics/logo.jpeg" alt="" style="height: 50px; margin-left:25px; margin-top:10px;"></a>
        ...
        <img src="statics/Premium.jpeg" alt="" style="width:100%; position:absolute; z-index:-1">
